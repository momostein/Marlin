...
#define STRING_CONFIG_H_AUTHOR "(Toon Meynen 02/02/19 20:47)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BrechtPrinter"
#define CUSTOM_MACHINE_NAME "M Printer"
...
#define LCD_FEEDBACK_FREQUENCY_HZ 2093 // C8
